    ...
    for (let secondIndex = 0; secondIndex < map[index].length; secondIndex++) {
      if (map[index][secondIndex] == 1) {
        ...
        if (secondIndex > 0 && map[index][secondIndex - 1] == 1) {
          createRect(
            secondIndex * blockSize,
            index * blockSize + wallOffset,
        ...
        if (
          secondIndex < map[index].length - 1 &&
          map[index][secondIndex + 1] == 1
        ) {
          createRect(
            secondIndex * blockSize + wallOffset,
            index * blockSize + wallOffset,
            wallSpaceWidth + wallOffset,
            wallSpaceWidth,
            wallInnerColour,
  ...
  for (let index = 0; index < map.length; index++) {
    for (let secondIndex = 0; secondIndex < map[index].length; secondIndex++) {
      if (map[index][secondIndex] == 2) {
        // Food
        createRect(
          secondIndex * blockSize + blockSize / 3,
          index * blockSize + blockSize / 3,
          blockSize / 3,
          blockSize / 3,
          foodColour,
        );
